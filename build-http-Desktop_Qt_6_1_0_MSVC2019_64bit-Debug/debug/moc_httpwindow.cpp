...
QT_MOC_LITERAL(160, 5), // "write"
QT_MOC_LITERAL(166, 14), // "authentication"
QT_MOC_LITERAL(181, 9), // "sslErrors"
QT_MOC_LITERAL(191, 16), // "QList<QSslError>"
QT_MOC_LITERAL(208, 6) // "errors"
    ...
    "authenticator\0write\0authentication\0"
...
void HttpWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->write(); break;
        case 7: _t->authentication((*reinterpret_cast< QNetworkReply*(*)>(_a[1])),(*reinterpret_cast< QAuthenticator*(*)>(_a[2]))); break;
